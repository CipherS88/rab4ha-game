...
class GameLayoutConfig {
  ...
  static final defaults = GameLayoutConfig(
    ...
    elements: {
      ...
      'btn_ekkah': GameLayoutBox(x: 0.7849, y: 0.508, w: 0.2209, h: 0.0525),
      'btn_sawa': GameLayoutBox(x: 0.7849, y: 0.5723, w: 0.2209, h: 0.0525),
      'btn_qaid': GameLayoutBox(x: 0, y: 0.5706, w: 0.1957, h: 0.0548),
